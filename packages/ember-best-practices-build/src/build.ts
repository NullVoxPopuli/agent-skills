...
async function build() {
  try {
    ...
    try {
      ...
      console.warn('Warning: Could not read _sections.md, using defaults', error);
    }
    ...
    try {
      ...
      metadata = {
        ...
        abstract: 'Performance optimization guide for Ember.js applications, ordered by impact.',
      };
    }
